...
def get_resion_item(input_img, imgsz=416, weights="weights/kaimono/kaimono_0822/best_kaimono_e1000_20200822.pt", conf_thre =0.5):
	...
	with torch.no_grad():
		...
		return item_region, egg_flag


# 学習済みモデルの重みを用いてアイテム検出（yochimonji）
def get_resion_item_pretrain(input_img, imgsz=416, weights="weights/kaimono/kaimono_0822/best_kaimono_e1000_20200822.pt", conf_thre =0.5):
...
if __name__ == '__main__':
	...
	# get_region_item_pretrainの動作確認(yochimonji)
	# frame_box = cv2.imread("inference/images/frame_box.jpg")
	# weights_item = "weights/yolov5x.pt"
	# get_resion_item_pretrain(frame_box, weights=weights_item, conf_thre=0.7)